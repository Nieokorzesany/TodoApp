...
// Module
exports.push([module.i, ".zSi_nuia2URerXIk3-tUr {\r\n  background-color: #f5f5f5;\r\n  color: #222;\r\n  display: flex;\r\n  flex-direction: column;\r\n  flex-wrap: nowrap;\r\n  justify-content: center;\r\n  align-items: center;\r\n  align-content: center;\r\n  width: 100vw;\r\n  height: 100vh;\r\n  text-align: center;\r\n}\r\n", ""]);

// Exports
exports.locals = {
	"TodoApp": "zSi_nuia2URerXIk3-tUr"
};
...
exports = module.exports = __webpack_require__(2)(false);
// Module
exports.push([module.i, "._3RInI_5OqHRN2RVPReZN-x {\r\n  display: flex;\r\n  flex-direction: row;\r\n  justify-content: space-between;\r\n  width: 300px;\r\n}\r\n\r\n._3RInI_5OqHRN2RVPReZN-x button {\r\n  width: 30px;\r\n  height: 30px;\r\n  align-self: center;\r\n}\r\n", ""]);

// Exports
exports.locals = {
	"Todo": "_3RInI_5OqHRN2RVPReZN-x"
};
...
var Containers_App = __webpack_require__(7);
...
var Title_Title = function Title(props) {
  return react_default.a.createElement("div", null, react_default.a.createElement("h1", null, props.title), react_default.a.createElement("h2", null, props.tasks, " todos"));
};
...
var TodoForm_TodoForm = function TodoForm(props) {
  return react_default.a.createElement("div", null, react_default.a.createElement("input", {
    ...
    onClick: function onClick() {
      return props.addTodo(props.todo);
    }
  }, "Add"));
};

/* harmony default export */ var Components_TodoForm = (TodoForm_TodoForm);
// EXTERNAL MODULE: ./src/Components/Todo.css
var Components_Todo = __webpack_require__(9);
var Todo_default = /*#__PURE__*/__webpack_require__.n(Components_Todo);
...
var Todo_Todo = function Todo(props) {
  ...
  }, react_default.a.createElement("h1", null, props.text), react_default.a.createElement("button", {
    onClick: function onClick() {
...
/* harmony default export */ var src_Components_Todo = (Todo_Todo);
// CONCATENATED MODULE: ./src/Components/TodoList.js



var TodoList_TodoList = function TodoList(props) {
  var listTodo = props.data.map(function (todo) {
    return react_default.a.createElement("div", {
      key: todo.id
    }, react_default.a.createElement(src_Components_Todo, {
      text: todo.text,
      id: todo.id,
      remove: props.remove
    }));
  });
  return react_default.a.createElement("div", null, listTodo);
};
...
function (_React$Component) {
  ...
  function App(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleAddTodoChange", function (event) {
      _this.setState({
        todo: event.target.value
      });
    });

    _defineProperty(_assertThisInitialized(_this), "addTodo", function (val) {
      var todo = {
        text: val,
    ...
    _defineProperty(_assertThisInitialized(_this), "removeTodo", function (id) {
